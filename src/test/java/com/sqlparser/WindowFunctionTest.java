...
class WindowFunctionTest {
    ...
    void testRankDenseRank() throws JSQLParserException {
    ...
    void testPercentRankCumeDist() throws JSQLParserException {
    ...
    void testRunningTotals() throws JSQLParserException {
    ...
    void testMovingAverages() throws JSQLParserException {
    ...
    void testLagFunction() throws JSQLParserException {
    ...
    void testLeadFunction() throws JSQLParserException {
        String sql = "SELECT date, value, " +
    ...
    void testLagWithDefault() throws JSQLParserException {
    ...
    void testFirstValue() throws JSQLParserException {
    ...
    void testLastValue() throws JSQLParserException {
        String sql = "SELECT session_id, page, " +
    ...
    void testNtile() throws JSQLParserException {
    ...
    void testMultipleNtile() throws JSQLParserException {
    ...
    void testRangeBetween() throws JSQLParserException {
    ...
    void testMultiplePartitions() throws JSQLParserException {
    ...
    void testNamedWindow() throws JSQLParserException {
    ...
    void testComplexOrderBy() throws JSQLParserException {
    ...
    void testFilterClause() throws JSQLParserException {
    ...
    void testStddevWindow() throws JSQLParserException {
        String sql = "SELECT date, price, " +
    ...
    void testWindowInExpression() throws JSQLParserException {
        String sql = "SELECT date, value, " +
    ...
    void testWindowInCase() throws JSQLParserException {
        String sql = "SELECT id, value, " +
    ...
    void testPercentileCont() throws JSQLParserException {
    ...
    void testPercentileDisc() throws JSQLParserException {
        String sql = "SELECT category, price, " +
    ...
    void testRowsBetween() throws JSQLParserException {
        String sql = "SELECT date, value, " +
    ...
    void testEmptyOver() throws JSQLParserException {
        String sql = "SELECT id, value, " +
    ...
    void testCountWindow() throws JSQLParserException {
    ...
    void testMaxMinWindow() throws JSQLParserException {
        String sql = "SELECT date, price, " +
    ...
    void testWindowInSubquery() throws JSQLParserException {
    ...
    void testDescriptionWithWindows() throws JSQLParserException {
